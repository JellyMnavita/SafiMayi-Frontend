...
export function AccountPopover({ data = [], sx, ...other }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(IconButton, { onClick: handleOpenPopover, sx: {
                    ...
                    paper: {
                        ...
                        }, children: data.map((option) => (_jsxs(MenuItem, { selected: option.href === pathname, onClick: () => handleClickItem(option.href), children: [option.icon, option.label] }, option.label))) }), _jsx(Divider, { sx: { borderStyle: 'dashed' } }), _jsx(Box, { sx: { p: 1 }, children: _jsx(Button, { fullWidth: true, color: "error", href: "/", size: "medium", variant: "text", children: "D\u00E9connexion" }) })] })] }));
}
