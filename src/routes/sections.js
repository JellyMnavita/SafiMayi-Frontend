...
export const Parametres = lazy(() => import('../pages').then(m => ({ default: m.Parametres })));
...
export const routesSection = [
    {
        ...
        children: [
            ...
            { path: 'journaux', element: _jsx(JournauxView, {}) },
            { path: 'siteforage', element: _jsx(SiteForageView, {}) },
            { path: 'parametres', element: _jsx(Parametres, {}) },
        ],
    },
    {
        path: '/',
