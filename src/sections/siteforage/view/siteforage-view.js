...
export function SiteForageView() {
    ...
    useEffect(() => {
        let filtered = [...sites];
        if (searchNom) {
            filtered = filtered.filter(site => site.nom.toLowerCase().includes(searchNom.toLowerCase()));
        }
        if (searchLocalisation) {
            filtered = filtered.filter(site => site.localisation.toLowerCase().includes(searchLocalisation.toLowerCase()));
        }
        if (typeFilter) {
    ...
    return (_jsxs(Box, { sx: { width: '100%', p: 3 }, children: [_jsx(Box, { sx: { mb: 3, display: "flex", alignItems: "center", flexWrap: 'wrap' }, children: _jsx(Typography, { variant: "h4", sx: { flexGrow: 1, mb: { xs: 2, sm: 0 } }, children: "Sites de Forage" }) }), _jsx(Card, { sx: { p: 2, mb: 3 }, children: _jsxs(Box, { sx: {
                        ...
                        '& > *': { minWidth: '120px', flexGrow: 1 }
                                ...
                                setTypeFilter("");
                                setStatutFilter("");
                            }, children: "R\u00E9initialiser" })] }) }), _jsxs(Box, { sx: {
                    display: 'flex',
                    ...
                    height: '70vh'
                        ...
                        }, children: [_jsx("div", { ref: mapContainer, style: { width: "100%", height: "100%", minHeight: '300px' } }), !mapLoaded && (_jsx(Box, { sx: {
                                    position: "absolute",
                                    top: 0,
                                    left: 0,
                                    right: 0,
