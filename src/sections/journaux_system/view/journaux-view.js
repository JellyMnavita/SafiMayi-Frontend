...
export function JournauxView() {
    ...
    return (_jsxs(DashboardContent, { children: [_jsxs(Box, { sx: { mb: 3, display: "flex", alignItems: "center" }, children: [_jsx(Typography, { variant: "h4", sx: { flexGrow: 1 }, children: "Journaux" }), _jsx(Button, { variant: "contained", color: "inherit", startIcon: _jsx(Iconify, { icon: "solar:restart-bold" }), onClick: refreshData, children: "Actualiser" })] }), _jsx(Card, { sx: { mb: 3, overflow: 'auto' }, children: _jsxs(Tabs, { value: activeTab, onChange: handleTabChange, variant: isMobile ? "scrollable" : "standard", scrollButtons: isMobile ? "auto" : false, allowScrollButtonsMobile: true, sx: {
                    ...
                    '& .slick-slide > div': {
                        ...
                        width: '100%'
                ...
                }, children: activeTab === 1 ? (_jsxs(Slider, { ...sliderSettings, children: [_jsx("div", { children: _jsx(AnalyticsWidgetSummary, { title: "Montant Total", total: statsPaiements.montant_total || 0, color: "primary", suffix: " FC", isCurrency: true, icon: _jsx("img", { alt: "Revenue", src: "/assets/icons/glass/ic-glass-buy.svg" }), sx: { height: '100%' } }) }), _jsx("div", { children: _jsx(AnalyticsWidgetSummary, { title: "Paiements R\u00E9ussis", total: statsPaiements.reussis || 0, color: "success", icon: _jsx("img", { alt: "RFID", src: "/assets/icons/glass/ic-glass-users.svg" }), sx: { height: '100%' } }) }), _jsx("div", { children: _jsx(AnalyticsWidgetSummary, { title: "En Attente", total: statsPaiements.en_attente || 0, color: "warning", icon: _jsx("img", { alt: "Water", src: "/assets/icons/glass/ic-glass-message.svg" }), sx: { height: '100%' } }) }), _jsx("div", { children: _jsx(AnalyticsWidgetSummary, { title: "\u00C9chou\u00E9s", total: statsPaiements.echecs || 0, color: "error", icon: _jsx("img", { alt: "Total", src: "/assets/icons/glass/ic-glass-bag.svg" }), sx: { height: '100%' } }) })] })) : (_jsxs(Slider, { ...sliderSettings, children: [_jsx("div", { children: _jsx(AnalyticsWidgetSummary, { title: "Total Consommations", total: statsConsommations.total_consommations || 0, color: "primary", icon: _jsx("img", { alt: "Total", src: "/assets/icons/glass/ic-glass-bag.svg" }), sx: { height: '100%' } }) }), _jsx("div", { children: _jsx(AnalyticsWidgetSummary, { title: "Litres Total", total: statsConsommations.total_litres || 0, color: "success", suffix: " L", icon: _jsx("img", { alt: "Water", src: "/assets/icons/glass/ic-glass-message.svg" }), sx: { height: '100%' } }) }), _jsx("div", { children: _jsx(AnalyticsWidgetSummary, { title: "Prix Total", total: statsConsommations.total_prix || 0, color: "info", suffix: " FC", isCurrency: true, icon: _jsx("img", { alt: "Revenue", src: "/assets/icons/glass/ic-glass-buy.svg" }), sx: { height: '100%' } }) }), _jsx("div", { children: _jsx(AnalyticsWidgetSummary, { title: "B\u00E9n\u00E9fice Total", total: statsConsommations.benefice_total || 0, color: "warning", suffix: " FC", isCurrency: true, icon: _jsx("img", { alt: "Profit", src: "/assets/icons/glass/ic-glass-users.svg" }), sx: { height: '100%' } }) })] })) })), _jsx(Card, { children: _jsx(Box, { sx: { width: '100%', overflow: 'hidden' }, children: ((activeTab === 0 && loadingRecharges) || (activeTab === 1 && loadingPaiements) || (activeTab === 2 && loadingConsommations)) ? (_jsx(Box, { sx: { display: 'flex', justifyContent: 'center', alignItems: 'center', py: 10 }, children: _jsx(CircularProgress, {}) })) : (_jsxs(_Fragment, { children: [_jsx(Box, { sx: { overflowX: 'auto', width: '100%' }, children: activeTab === 0 ? (_jsx(Box, { sx: { minWidth: 800 }, children: _jsxs("table", { style: { width: '100%', borderCollapse: 'collapse' }, children: [_jsx("thead", { children: _jsxs("tr", { style: { backgroundColor: '#f8f9fa', textAlign: 'left' }, children: [_jsx("th", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0', fontWeight: 600 }, children: "Date" }), _jsx("th", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0', fontWeight: 600 }, children: "Utilisateur" }), _jsx("th", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0', fontWeight: 600 }, children: "T\u00E9l\u00E9phone" }), _jsx("th", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0', fontWeight: 600 }, children: "Carte RFID" }), _jsx("th", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0', fontWeight: 600 }, children: "Litres" }), _jsx("th", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0', fontWeight: 600 }, children: "Moyen" }), _jsx("th", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0', fontWeight: 600, textAlign: 'center' }, children: "Actions" })] }) }), _jsx("tbody", { children: recharges.length > 0 ? (recharges.map((item, index) => (_jsxs("tr", { className: "table-row", style: { cursor: 'pointer' }, onClick: () => handleRowClick(item, 'recharge'), children: [_jsx("td", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0' }, children: formatDate(item.Date) }), _jsx("td", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0' }, children: item.Utilisateur }), _jsx("td", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0' }, children: item.Telephone }), _jsx("td", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0' }, children: item["Carte RFID"] || "-" }), _jsxs("td", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0' }, children: [item.Litre.toFixed(1), " L"] }), _jsx("td", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0' }, children: _jsx(Chip, { label: item.Moyen, color: "primary", size: "small", variant: "filled" }) }), _jsx("td", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0', textAlign: 'center' }, onClick: (e) => e.stopPropagation(), children: _jsx(IconButton, { onClick: (e) => handleMenuOpen(e, item, 'recharge'), children: _jsx(Iconify, { icon: "eva:more-vertical-fill" }) }) })] }, index)))) : (_jsx("tr", { children: _jsx("td", { colSpan: 7, style: { textAlign: 'center', color: '#6b7280', padding: '24px' }, children: _jsx(Typography, { variant: "h6", color: "text.secondary", children: "Aucune recharge trouv\u00E9e" }) }) })) })] }) })) : activeTab === 1 ? (_jsx(Box, { sx: { minWidth: 1100 }, children: _jsxs("table", { style: { width: '100%', borderCollapse: 'collapse' }, children: [_jsx("thead", { children: _jsxs("tr", { style: { backgroundColor: '#f8f9fa', textAlign: 'left' }, children: [_jsx("th", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0', fontWeight: 600 }, children: "Date" }), _jsx("th", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0', fontWeight: 600 }, children: "Utilisateur" }), _jsx("th", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0', fontWeight: 600 }, children: "T\u00E9l\u00E9phone" }), _jsx("th", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0', fontWeight: 600 }, children: "Carte RFID" }), _jsx("th", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0', fontWeight: 600 }, children: "Op\u00E9rateur" }), _jsx("th", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0', fontWeight: 600 }, children: "Montant" }), _jsx("th", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0', fontWeight: 600 }, children: "Litres" }), _jsx("th", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0', fontWeight: 600 }, children: "Statut" }), _jsx("th", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0', fontWeight: 600, textAlign: 'center' }, children: "Actions" })] }) }), _jsx("tbody", { children: paiements.length > 0 ? (paiements.map((item) => (_jsxs("tr", { className: "table-row", style: { cursor: 'pointer' }, onClick: () => handleRowClick(item, 'paiement'), children: [_jsx("td", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0' }, children: formatDate(item.created_at) }), _jsxs("td", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0' }, children: [item.utilisateur_nom || 'N/A', item.utilisateur_email && (_jsx(Box, { sx: { fontSize: '0.75rem', color: '#6b7280' }, children: item.utilisateur_email }))] }), _jsx("td", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0' }, children: item.telephone }), _jsx("td", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0' }, children: item.rfid_uid || 'Aucune' }), _jsx("td", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0' }, children: item.operateur }), _jsxs("td", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0' }, children: [item.montant, " FC"] }), _jsxs("td", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0' }, children: [item.litres_credite, " L"] }), _jsx("td", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0' }, children: _jsx(Chip, { label: getStatusText(item.statut), color: getStatusColor(item.statut), size: "small" }) }), _jsx("td", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0', textAlign: 'center' }, onClick: (e) => e.stopPropagation(), children: _jsx(IconButton, { onClick: (e) => handleMenuOpen(e, item, 'paiement'), children: _jsx(Iconify, { icon: "eva:more-vertical-fill" }) }) })] }, item.id)))) : (_jsx("tr", { children: _jsx("td", { colSpan: 9, style: { textAlign: 'center', color: '#6b7280', padding: '24px' }, children: _jsx(Typography, { variant: "h6", color: "text.secondary", children: "Aucun paiement trouv\u00E9" }) }) })) })] }) })) : (_jsx(Box, { sx: { minWidth: 1200 }, children: _jsxs("table", { style: { width: '100%', borderCollapse: 'collapse' }, children: [_jsx("thead", { children: _jsxs("tr", { style: { backgroundColor: '#f8f9fa', textAlign: 'left' }, children: [_jsx("th", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0', fontWeight: 600 }, children: "Date" }), _jsx("th", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0', fontWeight: 600 }, children: "Compteur" }), _jsx("th", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0', fontWeight: 600 }, children: "Litres" }), _jsx("th", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0', fontWeight: 600 }, children: "Prix" }), _jsx("th", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0', fontWeight: 600 }, children: "Type" }), _jsx("th", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0', fontWeight: 600 }, children: "Utilisateur" }), _jsx("th", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0', fontWeight: 600, textAlign: 'center' }, children: "Actions" })] }) }), _jsx("tbody", { children: consommations.length > 0 ? (consommations.map((item) => (_jsxs("tr", { className: "table-row", style: { cursor: 'pointer' }, onClick: () => handleRowClick(item, 'consommation'), children: [_jsx("td", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0' }, children: formatDate(item.date) }), _jsxs("td", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0' }, children: [item.compteur_nom, _jsx(Box, { sx: { fontSize: '0.75rem', color: '#6b7280' }, children: item.compteur_code_serie })] }), _jsxs("td", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0' }, children: [item.litres, " L"] }), _jsxs("td", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0' }, children: [formatCurrency(item.prix_total || 0), " FC"] }), _jsx("td", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0' }, children: _jsx(Chip, { label: item.type, color: getTypeColor(item.type), size: "small" }) }), _jsxs("td", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0' }, children: [item.utilisateur_nom || "Anonyme", item.utilisateur_telephone && (_jsx(Box, { sx: { fontSize: '0.75rem', color: '#6b7280' }, children: item.utilisateur_telephone }))] }), _jsx("td", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0', textAlign: 'center' }, onClick: (e) => e.stopPropagation(), children: _jsx(IconButton, { onClick: (e) => handleMenuOpen(e, item, 'consommation'), children: _jsx(Iconify, { icon: "eva:more-vertical-fill" }) }) })] }, item.id)))) : (_jsx("tr", { children: _jsx("td", { colSpan: 7, style: { textAlign: 'center', color: '#6b7280', padding: '24px' }, children: _jsx(Typography, { variant: "h6", color: "text.secondary", children: "Aucune consommation trouv\u00E9e" }) }) })) })] }) })) }), _jsxs(Box, { sx: {
                                    display: "flex",
                                    justifyContent: "space-between",
                                    alignItems: "center",
                                    p: 2,
                                    ...
                                    borderTop: 1,
                                    borderColor: 'divider'
                                }, children: [_jsx(Typography, { variant: "body2", color: "text.secondary", children: `Affichage de ${recharges.length} sur ${totalCount} ${activeTab === 0 ? 'recharges' :
