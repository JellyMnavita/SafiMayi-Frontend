                            ...
                            setError("");
                                ...
                                borderColor: 'divider'
                                                        ...
                                                        setError("");
                                                                    ...
                                                                    alignItems: 'center',
                                                                    gap: 1
                                                                }, children: _jsx(Typography, { variant: "body2", fontWeight: "medium", children: user.nom }) }) }), _jsx("td", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0' }, children: _jsx(Typography, { variant: "body2", children: user.email }) }), _jsx("td", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0' }, children: user.telephone ? (_jsx(Typography, { variant: "body2", children: user.telephone })) : (_jsx(Typography, { variant: "body2", color: "text.secondary", children: "-" })) }), _jsx("td", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0' }, children: _jsx(Chip, { label: getRoleLabel(user.role), size: "small", variant: "outlined", color: user.role === 'admin' ? 'error' :
                                                                    user.role === 'owner' ? 'warning' :
                                                                        user.role === 'agent' ? 'info' :
                                                                            user.role === 'gerant' ? 'secondary' : 'default' }) }), _jsx("td", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0' }, children: user.state ? (_jsx(Chip, { label: "Actif", size: "small", color: "success", variant: "filled" })) : (_jsx(Chip, { label: "Inactif", size: "small", color: "error", variant: "filled" })) }), _jsx("td", { style: { padding: '12px', borderBottom: '1px solid #e0e0e0', textAlign: 'center' }, children: _jsx(IconButton, { onClick: (e) => {
                                                                    e.stopPropagation();
                                                                    handleMenuOpen(e, user);
                                                                }, size: "small", children: _jsx(Iconify, { icon: "eva:more-vertical-fill" }) }) })] }, user.id)))) : (_jsx("tr", { children: _jsxs("td", { colSpan: 6, style: { textAlign: 'center', color: '#6b7280', padding: '24px' }, children: [_jsx(Typography, { variant: "h6", color: "text.secondary", children: "Aucun utilisateur trouv\u00E9" }), _jsx(Typography, { variant: "body2", color: "text.secondary", sx: { mt: 1 }, children: "Essayez de modifier vos crit\u00E8res de recherche" })] }) })) })] }) }) }), _jsxs(Box, { sx: {
                                    display: "flex",
                                    justifyContent: "space-between",
                                    alignItems: "center",
                                    p: 2,
