                                ...
                                borderColor: 'divider'
                                        ...
                                        setSearchUserFilter(newInputValue);
                                                ...
                                                setMode("single");
                                                            ...
                                                            bgcolor: '#0486d9',
                                                            color: 'white'
                                                        }, children: _jsx(Typography, { variant: "body2", fontWeight: "bold", children: compteur.code_serie || "N/A" }) }) }), _jsx("td", { className: "p-3 border-b", children: compteur.siteforage_nom ? (_jsx(Chip, { label: compteur.siteforage_nom, size: "small", variant: "outlined", color: "primary" })) : (_jsx(Typography, { variant: "body2", color: "text.secondary", children: "-" })) }), _jsx("td", { className: "p-3 border-b", children: compteur.user_nom ? (_jsx(Chip, { label: compteur.user_nom, size: "small", variant: "outlined", color: "secondary" })) : (_jsx(Typography, { variant: "body2", color: "text.secondary", children: "-" })) }), _jsx("td", { className: "p-3 border-b", children: _jsx(Chip, { label: compteur.statut || 'Non défini', size: "small", color: compteur.statut === 'installe' ? 'success' :
                                                            compteur.statut === 'en panne' ? 'error' : 'default', variant: "filled" }) }), _jsx("td", { className: "p-3 border-b", children: _jsx(Typography, { variant: "body2", children: compteur.date_installation ?
                                                            new Date(compteur.date_installation).toLocaleDateString() :
                                                            "Non installé" }) }), _jsx("td", { className: "p-3 border-b", children: compteur.actif ? (_jsx("span", { className: "bg-green-100 text-green-700 px-2 py-1 rounded-full text-xs font-medium", children: "Actif" })) : (_jsx("span", { className: "bg-red-100 text-red-700 px-2 py-1 rounded-full text-xs font-medium", children: "D\u00E9sactiv\u00E9" })) }), _jsx("td", { className: "p-3 border-b text-center", children: _jsx(IconButton, { onClick: (e) => {
                                                            e.stopPropagation();
                                                            handleMenuOpen(e, compteur);
                                                        }, size: "small", disabled: toggling === compteur.id, children: toggling === compteur.id ? (_jsx(CircularProgress, { size: 20 })) : (_jsx(Iconify, { icon: "eva:more-vertical-fill" })) }) })] }, compteur.id)))) : (_jsx("tr", { children: _jsxs("td", { colSpan: 7, className: "text-center text-gray-500 py-6", children: [_jsx(Typography, { variant: "h6", color: "text.secondary", children: "Aucun compteur trouv\u00E9" }), _jsx(Typography, { variant: "body2", color: "text.secondary", sx: { mt: 1 }, children: "Essayez de modifier vos crit\u00E8res de recherche" })] }) })) })] }), _jsxs(Box, { sx: {
                                    display: "flex",
                                    justifyContent: "space-between",
                                    alignItems: "center",
                                    mt: 2,
